...
interface ILogoProps extends StackProps {
  hideIcon?: boolean;
...
export const Logo: React.FC<ILogoProps> = ({
  ...
  return (
    <Link href="https://thirdweb.com" target={"_blank"}>
      <Stack as="h1" align="center" direction="row" {...restProps}>
        {hideIcon ?? <IconLogo w={{ base: 12, md: 20 }} flexShrink={0} />}
        {hideWordmark ?? (
          <Wordmark color={color} w={{ base: 28, md: 64 }} flexShrink={0} />
        )}
